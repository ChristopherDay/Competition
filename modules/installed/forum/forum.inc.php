    ...
    class forum extends module {
        ...
        public function constructModule() {
            if (!isset($_REQUEST["action"])) {
                header("Location: ?page=forum&action=forum&id=1");
                exit;
            }
        }
        ...
        public function method_topic() {
            ...
            if (isset($this->methodData->submit)) {
                ...
                if (!$this->user) {
                    $this->error("You need to log in to reply!");
                    $error = true;
                } else {
        ...
        public function method_delete() {
            ...
            if (
                !$this->user || !$this->user->hasAdminAccessTo("forum")
            ) {
        ...
        public function method_deleteTopic() {
            ...
            if (!$this->user || !$this->user->hasAdminAccessTo("forum")) {
